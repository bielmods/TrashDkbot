	...
	client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `Ola seja bem vindo @${num.split('@')[0]}ðŸ‘‹`
				let buff = await getBuffer(ppimg)
				client.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
...
case 'textodeneve':
				...
				case 'welcome':
					...
					if (Number(args[0]) === 1) {
						...
						reply('Modo boas vindas ativado com sucesso neste grupo âœ”ï¸')
					} else if (Number(args[0]) === 0) {
				...
				case 'wait':
					...
					break
                                	case '(dono)':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`(data:image/png;base64,)`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '(Bot:TrashDkofcBOT\nNumero do meu dono:wa.me/558494740630\nnumero da cremosa do meu dono que ajudou no menu:wa.me/558494740630\nNome do meu dono:TrashфDkofcꪶ Número do meu dono😎🤙:WA.me/558494740630 😎🤙Youtube do meu dono:https://youtube.com/channel/UCOqlFzRrB8IZUWUx1cwCeUw Número da cremosa do meu dono que ajudou a fazer o menu 😎🤙ঔৣ☬✞𝐓𝐫𝐚𝐬𝐡|𝐉𝐮𝐰 ✞☬ঔৣ: wa.me/558491093889\nMeudono:ঔৣ͜͡TrashфDk'Ofcꪶ'))'})
					break
case 'porno':
